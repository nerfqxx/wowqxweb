                ...
                <div class="content-trail">
                    ...
                    if (isset($_GET['p'])) {
                        ...
                        if ($mode == "thread")
                            ...
                            $thread = mysql_fetch_assoc(mysql_query("SELECT * FROM forum_threads WHERE id = '" . $post['threadid'] . "'"));
                        ...
                        if ($post['author'] != $userInfo['id'] && $userInfo['class'] == "")
                            $error = 1;
	...
	<li>
                    ...
                    if (isset($_POST['edit'])) {
                        ...
                        if ($mode == "thread")
                            if (empty($_POST['subject'])) {
                                $errors[] = '' . $Forum['Forum11'] . '';
                            }
                        if (empty($_POST['detail'])) {
                            $errors[] = '' . $Forum['Forum12'] . '';
                        }
                        if ($error == 1) {
                            $errors[] = '' . $Forum['Forum13'] . '';
                        }
                        echo '<center>
		...
		<div class="loader"></div><br />';
                        ...
                        if (isset($errors) && count($errors) > 0) {
                            ...
                            if ($mode == "thread")
                                $insert = mysql_query("UPDATE forum_threads SET name = '" . $subject . "', content = '" . $content . "', last_date = '" . $ndate . "', edited = '1', editedby = '" . $userInfo['id'] . "' WHERE id = '" . $post['id'] . "'") or print(mysql_error());
                            else
                                $insert = mysql_query("UPDATE forum_replies SET content = '" . $content . "', last_date = '" . $ndate . "', edited = '1', editedby = '" . $userInfo['id'] . "' WHERE id = '" . $post['id'] . "'") or print('' . $Forum['Forum54'] . '');
                                            ...
                                            if ($error != 1) {
                                                ...
                                                <div class="post-edit">
                                                    ...
                                                    <div class="editor1" id="post-edit"><div class="bml-toolbar"></div>
                                                        ...
                                                        <?php
                                                        if ($mode == "thread")
                                                            echo '<input type="text" id="subject" name="subject" value="' . $post['name'] . '" class="post-subject" maxlength="55" />';
                                                        ?>
        ...
        //]]>
                                                ...
                                                if (!isset($_SESSION['username'])) {
                                                    echo '<div class="post-user-details "><center><h4>' . $Forum['Forum47'] . '</h4></center><br /></div>';
                                                } else {
