<?php
    ...
    $captchaEnable          = 1;            // ENABLE (1) / DISABLE (0) Captcha
    ...
    $DBUser             = "raiz";           // Your DB User
    $DBPassword         = "6713";       // Your DB Password

    $SOAPUser           = "nerfqx";          // SOAP USER
    $SOAPPassword       = "michelle013";          // SOAP USER PASSWORD
