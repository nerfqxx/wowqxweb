    ...
    if (isset($_POST['reg'])) {
        ...
        if (!$check) {
            ...
            if (strlen($_POST['accountPass']) < 5 || strlen($_POST['accountPass']) > 15) {
                ...
                die("<p align='center'>" . $Reg['Reg6'] . "<br><br>" . $Reg['Reg9'] . "<br><br>" . $Reg['Reg10'] . "" . $chars . " " . $Reg['Reg11'] . "<br><br>" . $Reg['Reg12'] . "<br><br>" . $Reg['Reg13'] . "</p><p align='center'><a href='register.php'><button class='ui-button button1' type='submit' value='back' tabindex='1'><span><span>" . $re['back'] . "</span></span></button></a></p>");
            }
...
<?php
        if (isset($error) && count($error) > 0) {
            ...
            if ($accinfo == 0) {
                ...
                $accountinfo2 = mysql_fetch_assoc(mysql_query("SELECT * FROM account WHERE username = UPPER('" . $accountName . "')"));
				$register_logon = mysql_query("INSERT INTO rbac_account_permissions (accountId) VALUES ('" . mysql_real_escape_string($accountinfo2['id']) . "')") or die(mysql_error());
